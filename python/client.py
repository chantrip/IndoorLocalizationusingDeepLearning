...
if __name__ == "__main__":
    ...
    #     fieldnames = ['random_seed','training_ratio','epochs','batch_size','N','scaling','sae_hidden_layers',
    #     'SAE_ACTIVATION','SAE_BIAS','SAE_OPTIMIZER','SAE_LOSS', 'classifier_hidden_layers','CLASSIFIER_ACTIVATION',
    #     'CLASSIFIER_BIAS','CLASSIFIER_OPTIMIZER','CLASSIFIER_LOSS','dropout','acc_bld','acc_flr','acc_bf','loc_failure'
    #     ,'mean_pos_err','mean_pos_err_weighted']
    end = datetime.now() 
    timeTaken = end - start
    output = {   "N": N,
                "acc_bf": acc_bf,
    ...
    # csvfname = 'sae.csv'
    # csvf_existed = os.path.isfile(csvfname)
    # with open(csvfname, 'a',newline='') as csvfile:
    #     fieldnames = ['random_seed','training_ratio','epochs','batch_size','N','scaling','sae_hidden_layers',
    #     'SAE_ACTIVATION','SAE_BIAS','SAE_OPTIMIZER','SAE_LOSS', 'classifier_hidden_layers','CLASSIFIER_ACTIVATION',
    #     'CLASSIFIER_BIAS','CLASSIFIER_OPTIMIZER','CLASSIFIER_LOSS','dropout','acc_bld','acc_flr','acc_bf','loc_failure'
    ...
    #     if not csvf_existed:
    #         writer.writeheader()
    #     writer.writerow({'random_seed':random_seed,'training_ratio':training_ratio,'epochs':epochs,'batch_size':batch_size,'N':N,'scaling':scaling,'sae_hidden_layers': sae_hidden_layers,
    #     'SAE_ACTIVATION': SAE_ACTIVATION, 'SAE_BIAS':SAE_BIAS,'SAE_OPTIMIZER':SAE_OPTIMIZER ,'SAE_LOSS':SAE_LOSS,'classifier_hidden_layers':classifier_hidden_layers ,'CLASSIFIER_ACTIVATION':CLASSIFIER_ACTIVATION,
    #     'CLASSIFIER_BIAS': CLASSIFIER_BIAS, 'CLASSIFIER_OPTIMIZER':CLASSIFIER_OPTIMIZER ,'CLASSIFIER_LOSS':CLASSIFIER_LOSS,'dropout':dropout ,'acc_bld':acc_bld,'acc_flr': acc_flr, 'acc_bf':acc_bf ,'loc_failure':loc_failure,
    #     'mean_pos_err':mean_pos_err,'mean_pos_err_weighted':mean_pos_err_weighted
    #     })
